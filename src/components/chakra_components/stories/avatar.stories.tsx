...
const GenericAvatar = (props: PropsOf<'svg'>) => (
  <svg color="#fff" viewBox="0 0 30 31" style={{ width: '56%', height: '56%' }} {...props}>
    <path
      fill="currentColor"
...
export const WithSizes = () => (
  <Stack direction="row" spacing="24px">
    {['xs', 'sm', 'md', 'lg', 'xl', '2xl'].map((size) => (
      <Avatar key={size} size={size} name="Uchiha Itachi" src="https://uinames.com/api/photos/female/18.jpg">
