            ...
            <DrawerBody>
              <Accordion allowMultiple>
                <AccordionItem>
                  ...
                  <AccordionPanel pb={4}>
                    <a href="https://chakra-ui.com/should-not-have-focus-if-panel-closed-1">Chakra 1</a>
                    <a href="https://chakra-ui.com/should-not-have-focus-if-panel-closed-2">Chakra 2</a>
                    <a href="https://chakra-ui.com/should-not-have-focus-if-panel-closed-3">Chakra 3</a>
                  </AccordionPanel>
                </AccordionItem>
                ...
                <AccordionItem>
                  ...
                  <AccordionPanel pb={4}>
                    <a href="https://chakra-ui.com/should-not-have-focus-if-panel-closed-4">Chakra 1</a>
                    <a href="https://chakra-ui.com/should-not-have-focus-if-panel-closed-5">Chakra 2</a>
                    <a href="https://chakra-ui.com/should-not-have-focus-if-panel-closed-6">Chakra 3</a>
                  </AccordionPanel>
                </AccordionItem>
              </Accordion>
            </DrawerBody>
