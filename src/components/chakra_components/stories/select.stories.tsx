...
export const SelectIcon = () => <Select icon={<UpDownIcon />} placeholder="Placeholder" size="md" />;

export const FocusAndErrorColors = () => (
  <Stack>
    <Select focusBorderColor="lime" placeholder="Here is a sample placeholder" />
    <Select focusBorderColor="pink.400" placeholder="Here is a sample placeholder" />

    <Select isInvalid errorBorderColor="red.300" placeholder="Here is a sample placeholder" />

    <Select isInvalid errorBorderColor="crimson" placeholder="Here is a sample placeholder" />
  </Stack>
);

export const OverrideStyles = () => (
  <Select color="white" height="60px" borderColor="tomato" bg="tomato" placeholder="Woohoo! A new background color!" />
);
